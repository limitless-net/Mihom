...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m15(error) => "Не удалось выбрать изображения: ${error}";

  static String m16(method) => "Неподдерживаемый HTTP метод: ${method}";

  static String m17(error) => "Загрузка не удалась: ${error}";
  ...
  static String m27(days) => "Подписка истёк через ${days} дней";

  static String m32(version) => "Текущая версия: ${version}";

  static String m33(version) => "Принудительное обновление: ${version}";

  static String m34(version) => "Найдена новая версия: ${version}";

  static String m35(statusCode) => "Сервер вернул код ошибки ${statusCode}";

  static String m36(label) => "${label} должен быть URL";

  static String m39(time) => "Время работы: ${time}";
