...
class _LoginDialogContentState extends State<_LoginDialogContent> {
  ...
  void _handleSubmit() {
    ...
    if (_isForgotPwd) {
      ...
      setState(() { _isForgotPwd = false; _codeCtrl.clear(); });
      return;
    }
            ...
            if (_isRegister || _isForgotPwd) ...[
              Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: _countdown > 0 ? null : _handleSendCode,
                    child: Container(
                      height: 48,
                      padding: const EdgeInsets.symmetric(horizontal: 14),
                      decoration: BoxDecoration(
                        gradient: _countdown > 0 ? null : t.buttonGradient,
                        color: _countdown > 0 ? (t.isDark ? const Color(0xFF2A2D45) : const Color(0xFFE0E0E0)) : null,
