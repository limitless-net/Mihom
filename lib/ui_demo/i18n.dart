...
class S {
  ...
  static String get campusModeDesc => isEn
      ? 'Optimized for campus networks. Internal campus resources (library, courses, email) connect directly without proxy, while external traffic goes through the proxy. Uses system proxy to avoid campus portal conflicts.'
      : '专为校园网环境优化。校内资源（图书馆、教务系统、校园邮箱等）直连不走代理，校外流量通过代理访问。使用系统代理模式避免校园网认证门户冲突。';
  static String get campusEnabled => isEn ? 'Campus mode enabled' : '已开启校园网模式';
  ...
  // ── 首页公告 ──
  static String get announcementTitle1 => isEn ? '🎉 New Version Released' : '🎉 新版本发布';
  static String get announcementDesc1 => isEn ? '${c.appName} v1.1.0 released with smart routing, TUN mode and more.' : '${c.appName} v1.1.0 已发布，新增智能选路、TUN 模式等功能，欢迎更新体验。';
  static String get announcementTime1 => isEn ? '2 hours ago' : '2 小时前';
  static String get announcementTitle2 => isEn ? '🔧 Maintenance Notice' : '🔧 线路维护通知';
  static String get announcementDesc2 => isEn ? 'Japan Tokyo02 node maintenance tonight 22:00-23:00.' : '日本东京02节点将于今晚 22:00-23:00 进行维护，届时该节点将暂时不可用。';
  static String get announcementTime2 => isEn ? '5 hours ago' : '5 小时前';
  static String get announcementTitle3 => isEn ? '💡 Tips' : '💡 使用提示';
  static String get announcementDesc3 => isEn ? 'Smart selection auto-connects to the lowest latency node.' : '开启智能选择后，系统将自动为您连接延迟最低的节点，无需手动切换。';
  static String get announcementTime3 => isEn ? '1 day ago' : '1 天前';
