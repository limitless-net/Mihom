...
/// 居中药丸形提示 — 替代 SnackBar
/// 返回一个 dismiss 回调，可在外部主动关闭（如订阅完成时）
VoidCallback showPillToast(BuildContext context, MihomTheme t, String text, {Duration duration = const Duration(milliseconds: 1800)}) {
...
class _PillToast extends StatefulWidget {
  ...
  const _PillToast({required this.theme, required this.text, required this.duration, required this.onDismiss});
